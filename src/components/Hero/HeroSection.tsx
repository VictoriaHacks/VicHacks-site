...
export default function HeroSection() {
  ...
  function setLogoPosition() {
    if (!gridRef?.current || !logoRef?.current)
      return 

    // Calculate the mid point of the grid
    const gridRect = gridRef.current.getBoundingClientRect()
    const midPointY = (gridRect.y + gridRect.height * GRID_CENTER_OFFSET + window.scrollY)
    ...
    const logoInnerHeight = logoRect.height - parseFloat(paddingTop) - parseFloat(paddingBottom)
  ...
  return (
    <div className="transition-opacity duration-500" style={{
      ...
      <div className="relative flex flex-col w-full min-h-svh gap-10 z-2">
        ...
        <Button href="#" className="mx-auto">SIGNUP</Button>
        ...
        <div className="flex gap-10 justify-between w-full mt-auto p-5 xs:p-10 flex-col md:flex-row">
          ...
          <div className="flex gap-10 min-w-none md:min-w-max">
            <Image className="max-w-16 sm:max-w-none hidden xs:flex" src={GridShapesImage} alt="Shape"/>
            <div className="space-y-1">
